...
Create a release to trigger the github action, named "Deploy Node.js package to portfolio website". Use the following structure for creating a release:

Tag: v0.0.1 -> v0.0.2 increment by 0.0.1 unless a major version.
Release Name: {version} Release Name

Note: Built in tests lookto see if the website is comiling and rendering objects properly. Tests are configured in /src/ setupTests.js and App.test.js
