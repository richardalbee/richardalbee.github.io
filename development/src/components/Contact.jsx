...
const Contact = ({ classicHeader, darkTheme }) => {
  ...
  const sendEmail = (e) => {
    e.preventDefault();
    setSendingMail(true);
    {/*Configured using EmailJS website. The values below is the email id linked to ralbee1@iwu.edu, email template id, followed by the emailJS account id. */}
    emailjs
      .sendForm(
        "service_t99bs4s",
        "template_vz0khmw",
            ...
            >
              <li className="social-icons-linkedin">
                <Tooltip text="LinkedIn" placement="top">
                  <a
                    href="https://www.linkedin.com/in/richard-albee/"
                    target="_blank"
              ...
              <li className="social-icons-github">
                <Tooltip text="Github" placement="top">
                  <a
                    href="http://www.github.com/richardalbee"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
